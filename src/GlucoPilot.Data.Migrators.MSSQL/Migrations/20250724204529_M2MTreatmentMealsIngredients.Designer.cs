...
namespace GlucoPilot.Data.Migrators.MSSQL.Migrations
{
    ...
    [Migration("20250724204529_M2MTreatmentMealsIngredients")]
    partial class M2MTreatmentMealsIngredients
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GlucoPilot.Data.Entities.Pen", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GlucoPilot.Data.Entities.TreatmentIngredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("treatments_ingredients");
                });

            modelBuilder.Entity("GlucoPilot.Data.Entities.TreatmentMeal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GlucoPilot.Data.Entities.TreatmentIngredient", b =>
                {
                    ...
                    b.HasOne("GlucoPilot.Data.Entities.Treatment", "Treatment")
                        .WithMany()
            ...
            modelBuilder.Entity("GlucoPilot.Data.Entities.User", b =>
                {
                    ...
                    b.OwnsOne("GlucoPilot.Data.Entities.UserSettings", "Settings", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");
